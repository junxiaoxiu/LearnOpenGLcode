...
int main()
{
    ...
    // -------------------------
    Shader shader("./shader/pointShadowing.vs", "./shader/pointShadowing.fs");
    Shader simpleDepthShader("./shader/cubeMap.vs", "./shader/cubeMap.fs", "./shader/cubeMap.gs");
    ...
    woodTexture = loadTexture("./resource/woodfloor.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // enable shadow by pressing SPACE
